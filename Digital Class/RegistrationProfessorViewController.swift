//
//  RegistrationProfessorViewController.swift
//  Digital Class
//
...
class RegistrationProfessorViewController: UIViewController {
    ...
    var messageLbl : UILabel = {
        let label = UILabel()
        label.backgroundColor = Utilities().darkBlueColor
        label.text = "Si quieres colaborar con tus colegas y estudiantes, pidele a la administracion de tu universidad que se ponga en contacto con nosotros"
...
extension RegistrationProfessorViewController : UITextFieldDelegate {
...
extension RegistrationProfessorViewController : UIPickerViewDelegate, UIPickerViewDataSource {
...
extension RegistrationProfessorViewController: UIImagePickerControllerDelegate,UINavigationControllerDelegate {
