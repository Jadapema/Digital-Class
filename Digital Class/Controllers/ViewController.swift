...
class ViewController: UIViewController {
    ...
    @objc func logInHandler () {
        ...
        guard self.userTxtF.text != nil && self.userTxtF.text != "" else {
            userTxtF.layer.borderColor = #colorLiteral(red: 0.5882352941, green: 0.1568627451, blue: 0.1058823529, alpha: 1)
            Utilities().littleDownMovement(view: userTxtF)
            return
        }
        guard utilities.isValidEmail(email: self.userTxtF.text!) else {
            userTxtF.layer.borderColor = #colorLiteral(red: 0.5882352941, green: 0.1568627451, blue: 0.1058823529, alpha: 1)
            userTxtF.text = ""
            userTxtF.attributedPlaceholder = NSAttributedString(string: "Correo mal estrucutado ej. me@mail.com",
        ...
        guard self.passTxtF.text != nil && self.passTxtF.text != "" else {
            userTxtF.layer.borderColor = #colorLiteral(red: 0.5921568627, green: 0.5921568627, blue: 0.5921568627, alpha: 1)
            passTxtF.layer.borderColor = #colorLiteral(red: 0.5882352941, green: 0.1568627451, blue: 0.1058823529, alpha: 1)
            utilities.littleDownMovement(view: passTxtF)
            return
        }

        
        FirebaseController().Login(email: userTxtF.text!, password: passTxtF.text!) {
